...
const FacultySignup = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // dispatch(setSignupRole("Faculty"));
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-4 flex flex-col items-start">
          ...
          <input
            ...
            className="text-sm w-full px-3 py-2 border rounded-md focus:outline-none focus:shadow-outline-blue"
            required
        ...
        {/* Faculty ID */}
        <div className="mb-4 flex flex-col items-start">
          <label htmlFor="facultyId" className="block text-gray-700 text-sm font-bold mb-2">
            Faculty ID
          </label>
          <input
            type="text"
