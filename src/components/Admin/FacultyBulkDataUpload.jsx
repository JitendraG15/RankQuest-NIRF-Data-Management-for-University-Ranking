...
import {insertFacultyInBulk} from "../../services/Admin/Admin";

const FacultyBulkDataUpload = () => {
  ...
  const handleClick = async () => {
    try {
      const formData = {faculties:excelData}
      console.log("Excel Data:", excelData)
      dispatch(insertFacultyInBulk(formData, navigate));
    } catch (error) {
      console.log(error);
    }
  };
...
export default FacultyBulkDataUpload;
